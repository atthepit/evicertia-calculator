...
describe("Calculator", () => {
  ...
  describe("fullDivision", () => {
    it("should return quotient and remainder of a division", () => {
      const result = Calculator.fullDivision(11, 3);
      const expected = { quotient: 3, remainder: 2 };
      expect(result).toEqual(expected);
    });
  });
