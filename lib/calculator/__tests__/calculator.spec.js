...
describe("Calculator", () => {
  describe("sum", () => {
    ...
    it("should throw an error if the arguments are not a numeric", () => {
      expect(() => {
        Calculator.sum(1, "a");
      }).toThrow();
      expect(() => {
  ...
  describe("sumAll", () => {
    ...
    it("should throw an error if the argument is not a numeric array", () => {
      const nums = [1, "a"];
      expect(() => {
  ...
  describe("substract", () => {
    ...
    it("should throw an error if the arguments are not a numeric", () => {
      expect(() => {
        Calculator.substract(1, "a");
      }).toThrow();
      expect(() => {
        Calculator.substract("a", 1);
      }).toThrow();
    });
  });
